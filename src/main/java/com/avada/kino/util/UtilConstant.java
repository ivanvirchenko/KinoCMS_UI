...
public interface UtilConstant {
    ...
    String MOVIE_TYPES = "Нужно выбрать хотя бы один тип";
    String IMAGE_ERROR = "Это обязательное изображение";
    String MAX_SIZE = "Максимальное количество символов - ";
    String URL_PATTERN = "https?:\\/\\/(www\\.)?[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&//=]*)";

    String CINEMA_ATTRIBUTE = "cinema";
